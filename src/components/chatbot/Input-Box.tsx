                    ...
                    <div className="flex gap-1">
                      {showSecretKeyInput ? (
                        <form onSubmit={handleKeySubmit} className="flex items-center">
                          ...
                          <button
                            type="submit"
                            className="text-white bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 focus:outline-none font-medium rounded-lg text-xs px-3 py-1.5 mr-1 shadow-sm hover:shadow-md transition-all duration-200"
                          >
                            Save
                          </button>
                          <button
                            ...
                            className="p-1 text-slate-500 dark:text-gray-400 hover:text-slate-800 dark:hover:text-white rounded-full transition-colors"
                          >
                            <X size={18} />
                          </button>
                        </form>
